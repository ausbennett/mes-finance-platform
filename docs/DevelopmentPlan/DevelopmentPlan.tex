...
\begin{itemize}
  \item \sout{\color{red}{\textbf{Redux} or \textbf{Context API}}}: To manage global state across the application.
...
\begin{itemize}
  \item \sout{\color{red}{\textbf{Istanbul/nyc}: To measure code coverage...}} \emph{\color{red}{(Caption: Removed due to scope reduction)}}
\end{itemize}
...
\begin{itemize}
  \item \sout{\color{red}{\textbf{Lighthouse}}: For checking performance, accessibility, and best practices of the frontend.}\emph{\color{red}{(Caption: Removed redundant tool)}}
  \item \textbf{Postman}: For testing API endpoints manually before they are integrated.
  \item \sout{\color{red}{\textbf{Valgrind} (optional)}: If memory profiling and performance are needed in specific areas of the backend.}\emph{\color{red}{(Caption: Removed as unnecessary for current phase)}}
\end{itemize}
...
\begin{itemize}
  \item \sout{\color{red}{\textbf{Vercel} or \textbf{Netlify}}: For deploying the Next.js application (frontend and backend API routes).}\emph{\color{red}{(Caption: Deployment strategy revised)}}
  \item \textbf{MongoDB Atlas}: To host the MongoDB database in the cloud.
  \item \sout{\color{red}{\textbf{Docker} (optional)}: For containerizing the application and ensuring a consistent environment across different stages.}\emph{\color{red}{(Caption: Containerization deemed unnecessary)}}
\end{itemize}
