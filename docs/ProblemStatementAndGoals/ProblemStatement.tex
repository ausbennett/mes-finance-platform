...
\begin{itemize}
    ...
    \item \emph{MES Financial Operations Team}: The financial personnel of the MES that support the VP Finance with daily operations such as processing reimbursements or funding requests. 
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \emph{Description}: create a centralized platform for students to submit requests, and MES finance personnel to approve and process requests
...
The extras chosen for this project will be usability testing and user documentation. Usability testing will be conducted with both students, and the administrative personnel of the MES finance team.
