...
\sout{\subsubsection{FRs for Custom Invoice Generation Feature}}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \hypertarget{APROne}{ \textbf{APR2.} The system's UI shall integrate MES branding throughout its UI screens, including MES brand colours, and logos. }
\end{itemize}
...
\begin{itemize}
    ...
    \item \hypertarget{STYRTWo}{ \textbf{STYR2.} The system's UI shall maintain a typography standard by using no more than 2 different fonts across the platform. The system shall use standard fonts used by the MES (if applicable). }
\end{itemize}
