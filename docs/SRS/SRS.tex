...
\begin{tabularx}{\textwidth}{p{0.1\textwidth} p{0.3\textwidth} p{0.2\textwidth} p{0.5\textwidth}}
\toprule
...
\midrule
4/4/25 & Evan Sturmey & \href{https://github.com/ausbennett/mes-finance-platform/commit/7e0a66622fbd429784351f832cb660610bc7d28d}{7e0a666} & Updating SRS to match with final product\\
...
\begin{itemize}
    ...
    \item \hypertarget{SPLRThree}{ \sout{\textbf{SPLR3.} Reimbursement requests shall be processed within 5 seconds.} }
\end{itemize}
...
\begin{itemize}
    \item \textbf{CPR1.} The system shall be able to handle 1000 reimbursement requests, \sout{1000 invoices,} and 500 payment requests daily.
