...
Output: Completed \hyperlink{checklist-nfr11}{checklist}, evaluating the ease of access of personalization features and their usefulness to the user
...
Output: Completed \hyperlink{checklist-nfr11}{checklist}, indicating the learnability of the system

How Test Will Be Performed: The user will be asked to complete a task with only the aid of the system's learning materials. They will then fill in a checklist of how accessible the information was and how much it helped them
\end{enumerate}
...
How Test Will Be Performed: The user will be given a list of text and instructions that appear when navigating the system. They will then fill out a checklist evaluating if they believe the instructions are written in plain language or use technical jargon.
\end{enumerate}
...
How Test Will Be Performed: The user will be asked to complete a task only using their keyboard and they will complete a checklist determining how simple it was to navigate with keyboard only.
\item {T2\\}\\
