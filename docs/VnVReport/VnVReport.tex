...
\subsubsection*{Notes}  
\begin{itemize}
    \item \st{\textbf{Failure in Ease of Use (Checklist 6.1.2.6):} The tutorial video was not easily accessible from the home page.}Following the final demo, we create a tutorial video which is now accessible.
