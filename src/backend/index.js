...
//Import and use club routes
const clubRoutes = require('./routes/club.routes');
const clubRoleRoutes = require('./routes/clubRole.routes');
const userRoutes = require('./routes/user.routes');
const reimbursementRoutes = require('./routes/reimbursement.routes');
const paymentRoutes = require('./routes/payment.routes');
const budgetLineRoutes = require('./routes/budgetLine.routes');

app.use('/api', clubRoutes);
app.use('/api/clubs', clubRoutes);
app.use('/api/clubRoles', clubRoleRoutes);
app.use('/api/users', userRoutes);
app.use('/api/reimbursements', reimbursementRoutes);
app.use('/api/payments', paymentRoutes);
app.use('/api/budgetLines', budgetLineRoutes);
