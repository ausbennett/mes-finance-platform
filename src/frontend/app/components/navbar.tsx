    ...
    return (
        <div className="navbar bg-foreground shadow-md px-5 py-3 rounded-xl">
            <div className="flex-1 cursor-pointer">
                <Image src="/mesLogo.png" alt="MES Logo" width={50} height={50} onClick={handleDashNav} />
            </div>
            <div className="flex-none space-x-4">
                {
                    !(currPage == "/adminDashboard" || currPage == "/userDashboard") && (
                        <button onClick={handleDashNav}>
                            Dashboard
                        </button>
                    )
                }
                <div className="avatar cursor-pointer" onClick={() => router.push("/accountInfo")}>
