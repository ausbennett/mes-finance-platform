...
export default function UserInfoGeneralPage() {
    ...
    return (
        <div id="screenContainer" className="flex flex-col items-center justify-center min-h-screen min-w-screen space-y-5 bg-background">
            ...
            <div className="flex flex-col items-start justify-center bg-foreground w-1/2 p-10 rounded-lg drop-shadow-lg space-y-5">
                ...
                <label className="form-control w-full">
                    ...
                    <input type="text" placeholder="John" className="bg-foreground px-3 py-2 rounded-md w-full border-white drop-shadow-md" />
                </label>
                <label className="form-control w-full">
                    <div className="label">
                        <span className="label-text">Last Name *</span>
                    </div>
                    <input type="text" placeholder="Smith" className="bg-foreground px-3 py-2 rounded-md w-full border-white drop-shadow-md" />
                </label>
                <label className="form-control w-full">
                    <div className="label">
                ...
                <div className="w-full  pt-5">
                    <button className="bg-primary text-white font-semilbold p-2 rounded-lg w-full drop-shadow-lg"
